...
public class Menu {
    ...
    public Menu() {
        ...
        this.officerMenu = Arrays.asList(
                ...
                "7. View account details",
                "8. Change account password",
                "9. Register to be a HDB officer of a project",
                "10. Check status of registration to be an officer for a project",
                "11. View project details",
                "12. Process flat booking",
                "13. View applications for assigned project",
                "14. Log out and return to main program",
                "Enter your choice: ");                            
