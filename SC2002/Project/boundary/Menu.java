...
public final class Menu {
    ...
    private static final List<String> OFFICER_MENU = Arrays.asList(
        ...
        "11. Register to be a HDB officer of a project",
        "12. Check status of registration to be an officer for a project",
        "13. View project details",
        "14. Process flat booking",
        "15. View applications for assigned project",
        "0. Log out and return to main program",
        "Enter your choice: "
    );
